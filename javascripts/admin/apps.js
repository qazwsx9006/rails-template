...
var BlankonApp = function(){
    ...
    // SETTINGS APP
    // =========================================================================
    var globalPluginsPath = '/assets/bower_components',//'/blankon-fullpack-admin-theme/1.0.3/assets/global/plugins/bower_components',
    ...
    return {
        ...
        handleCheckCookie: function () {
            ...
            if ($.cookie && $.cookie('page_sidebar_minimize') == 'active') {
